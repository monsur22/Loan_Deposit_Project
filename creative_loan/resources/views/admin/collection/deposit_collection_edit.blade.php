                            ...
                            <form method="POST" action="{{ url('/deposit-collection/update') }}">
                                ...
                                <div class="row">
                                        <div class="col-sm-4 form-group">
                                          <label>Date</label>
                                          <input class="form-control d_collection_date" type="date" id="d_collection_date" name="d_collection_date"value="{{$data_edit->d_collection_date}}"   >
                                          <input class="form-control cId" type="hidden" id="id" name="id" value="{{$data_edit->id}}">
                                        </div>
                                          <div class="col-sm-4 form-group">
                                              <label>Cullection Number</label>
                                              <input class="form-control d_collectin_number" type="text" id="d_collectin_number" name="d_collectin_number"value="{{$data_edit->d_collectin_number}}" readonly  >
                                          ...
                                          <div class="col-sm-4 form-group">
                                              ...
                                              <select class="form-control select2_demo_1 deposit_number_collection" name="deposit_number_collection"   id="deposit_number_collection">
                                                      ...
                                                      <option value="{{$item->id}}"@if($item->d_number == $data_edit->deposit_number_collection) selected @endif>{{$item->d_number}}</option>
                                                      @endforeach
                                         ...
                                         <div class="col-sm-4 form-group"style="visibility: hidden; display:none;">
                                              ...
                                              {{-- <select class="form-control select2_demo_1 account_number_collection" name="account_number_collection"value="{{$data_edit->account_number_collection}}"   id="account_number_collection">
                                                      @foreach ($deposit_number as $item)
                                                      <option value="{{$item->d_acc}}"@if($item->d_acc == $data_edit->account_number_collection) selected @endif>{{$item->d_acc}}</option>
                                                      @endforeach  
                                                      
                                                  </select> --}}
                                                  <input class="form-control account_number_collection" type="text" id="account_number_collection" name="account_number_collection" value="{{$data_edit->d_collection_name}}" readonly >
                                          </div>
                                             
                                          <div class="col-sm-4 form-group">
                                              <label>Name</label>
                                              <input class="form-control d_collection_name" type="text" id="d_collection_name" name="d_collection_name" value="{{$data_edit->d_collection_name}}" readonly >
                                          </div>
                                          <div class="col-sm-4 form-group">
                                            ...
                                            <select class="form-control d_collection_type" name="d_collection_type" id="d_collection_type">
                                              ...
                                              <option value="Bank">Bank</option>
                                                ...
                                                <input class="form-control d_collection_amount" type="number" id="d_collection_amount" name="d_collection_amount" value="{{$data_edit->d_collection_amount}}"  >
                                            </div>
