                        ...
                        <tbody>
                           ...
                           @foreach ($collectiondetails as $item)
                            ...
                            <td>
                                    ...
                                    <a href="{{route('c_confirm_statas',['id'=>$item->id])}}" class="btn btn-success" title="Active">
                                        <span class="fa fa-arrow-up"></span>
                                    </a>
                                    @elseif($item->c_confirm_status==0)
                                    <a href="{{route('c_confirm_statas',['id'=>$item->id])}}" class="btn btn-danger" title="Inactive">
                                            <span class="fa fa-arrow-down"></span>
                                        </a>
                                    @endif
                                       @endif        <button onclick='edit({{$item->id}})' data-toggle="modal" id="edit" data-target="#editcollection" class="btn btn-success" >
        ...
        $(document).ready(function(){  
             $('#c_edit_name').change(function(){  
                 ...
                 console.log(c_edit_name_id);
                  $.ajax({  
                       url:"{{url('/show-col')}}/"+c_edit_name_id,  
                       method:"GET",  
                       success:function(data){  
