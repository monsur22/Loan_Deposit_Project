...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form method="POST" action="{{url('/income-add')}}">
            {{csrf_field()}}
...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form method="POST" action="{{url('/income-voucher-update')}}">
            {{csrf_field()}}
            <div class="modal-body">
                    <div class="row">
                            <div class="col-sm-6">
                            ...
                            <td>{{$item->i_amount}}</td>
                                ...
                                <td>
                                        ...
                                        <button onclick='edit({{$item->id}})' data-toggle="modal" id="edit" data-target="#edit-income" class="btn btn-success" >
                                            ...
                                            <a href="{{url('income-voucher-delete/'.$item->id)}}" class="btn btn-danger" title="Delete"onclick="return confirm('Are you sure to delete this?'); ">
        ...
        $(document).ready(function(){  
             $('#i_debit_head').change(function(){  
                 ...
                 console.log(debit_head_id);
                  $.ajax({  
                       url:"{{url('/ishowdebit_b')}}/"+debit_head_id,  
                       method:"GET",  
