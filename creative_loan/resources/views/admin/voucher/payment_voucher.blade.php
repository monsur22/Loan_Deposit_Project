                            ...
                            <td>{{$item->p_amount}}</td>
                                ...
                                <td>
                                  ...
                                  @if ($item->user_role==1)
                                        ...
                                        <a href="{{route('p_confirm_statas',['id'=>$item->id])}}" class="btn btn-success" title="Active" >
                                            <span class="fa fa-arrow-up"></span>
                                        </a>
                                        @elseif($item->pconfirm_status==0)
                                        <a href="{{route('p_confirm_statas',['id'=>$item->id])}}" class="btn btn-danger" title="Inactive">
