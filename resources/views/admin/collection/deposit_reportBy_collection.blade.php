...
<h6><b> <u>Deposit Collection Report</u> </b></h6>
...
<h6><b> From: {{session('fromdate')}} To: {{session('todate')}}</b></h6>
    ...
    <div class="ibox"style="margin-top: 3px;">
            ...
            <div class="ibox-head">
                    ...
                    <form action="{{url('/deposit-collection-report')}}" method="get">
                                {{ csrf_field() }}
                                <div class="row">
            ...
            <div class="ibox-body">
                    <table class="table table-striped table-bordered table-hover" id="" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            @foreach ($deposit_collection as $item)
                            <tr>
                  
                            <td>{{$item->d_c_date}}</td>
                            <td>{{$item->d_collectin_number}}</td>
                            <td>{{$item->d_collection_amount}}</td>
