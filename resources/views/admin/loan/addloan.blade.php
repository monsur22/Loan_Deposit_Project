...
@section('content')
            ...
            <section class="panel">
                          <div class="panel-body">
                           <h3> Create New Loaner</h3>
                           <br>
                              <form class="form-horizontal" action="{{url('/loan-pakage')}}" method="POST">
                                    @csrf
                                     <div class="row">
                                    <h4 style="margin-left: 80px;"><b>Personal Information</b><br>
                                    <b>........................................</b><br><br><br>
                              <div class="col-sm-6">
                                ...
                                required>
                                 ...
                                 <div class="col-sm-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control input-lg m-bot15" id="usr" name="frist_name" placeholder="Frist Name" required>
                                       </div>
                                   </div>

                                   <div class="col-sm-4">
                                    <div class="form-group">
                                <label for="usr">Loan Number</label>
                                <input type="text" class="form-control input-lg m-bot15" id="usr" name="frist_name" placeholder="Frist Name"
                                required>
                              </div>
                                 </div>
                                  ...
                                  <div class="col-sm-4">
                                    ...
                                    <h4 style="margin-left: 80px;"><b>Select Loan Package</b><br>
                                    <b>........................................</b><br><br><br>
