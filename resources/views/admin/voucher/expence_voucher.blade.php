...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form method="POST" action="{{url('/expence-add')}}">
            {{csrf_field()}}
...
<div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form method="POST" action="{{url('/expence-update')}}">
            {{csrf_field()}}
            <div class="modal-body">
                    <div class="row">
                            <div class="col-sm-6">
                            ...
                            <td>{{$item->e_amount}}</td>
                                ...
                                <td>
                                    ...
                                    @if($item->confirm_id==1)
                                        <a href="{{route('econfirm_statas',['id'=>$item->id])}}" class="btn btn-success" title="Active">
                                            <span class="fa fa-arrow-up"></span>
                                        </a>
                                        @elseif($item->confirm_id==0)
                                        <a href="{{route('econfirm_statas',['id'=>$item->id])}}" class="btn btn-danger" title="Inactive">
                                     ...
                                     @endif
                                        ...
                                        <button onclick='edit({{$item->id}})' data-toggle="modal" id="edit" data-target="#edit-transection" class="btn btn-success" >
                                            ...
                                            <a href="{{url('expence-delete/'.$item->id)}}" class="btn btn-danger" title="Delete"onclick="return confirm('Are you sure to delete this?'); ">
        ...
        $(document).ready(function(){  
             $('#e_debit_head').change(function(){  
                 ...
                 console.log(debit_head_id);
                  $.ajax({  
                       url:"{{url('/eshowdebit_b')}}/"+debit_head_id,  
                       method:"GET",  
