...
<div class="page-content fade-in-up">
        ...
        <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Add Diposit Withdraw</div>
                    ...
                    <div class="ibox-body">
                            <form method="POST" action="{{ url('/diposit-withdraw') }}">
                                {{csrf_field()}}
                                <div class="row">
                       
                                        <div class="col-sm-4 form-group">
                                          <label>Date</label>
                                          <input class="form-control" type="date" id="d_withdraw_date" name="d_withdraw_date" value="<?php echo date('Y-m-d'); ?>">
                                        </div>
                                          <div class="col-sm-4 form-group">
                                                  <?php
                                              ...
                                              <input class="form-control" type="text" id="d_withdraw_number" name="d_withdraw_number" value="DW{{$date.$last_id++}}" readonly>
                                          ...
                                          <div class="col-sm-4 form-group">
                                              ...
                                              <select class="form-control select2_demo_1 " name="deposit_number_withdraw" id="deposit_number_withdraw">
                                         ...
                                         <div class="col-sm-4 form-group"style="visibility: hidden; display:none;">
                                          ...
                                          <div class="col-sm-4 form-group">
                                              <label>Name</label>
                                              <input class="form-control" type="text" id="d_withdraw_name" name="d_withdraw_name" readonly>
                                          </div>
                                          <div class="col-sm-4 form-group">
                                            <label>Collection Type</label>
                                            <select class="form-control" name="d_withdraw_type" id="d_withdraw_type">
                                              ...
                                              <option value="Bank">Bank</option>
                                                ...
                                                <input class="form-control" type="number" id="d_withdraw_amount" name="d_withdraw_amount" placeholder="">
                                            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item->d_withdraw_date}}</td>
                     
                            
                                <td>
                                   
                                    @if($item->d_withdraw_status==1)
                                    <a href="{{route('deposit_withdraw_statas',['id'=>$item->id])}}" class="btn btn-success" title="Active">
                                        <span class="fa fa-arrow-up"></span>
                                    </a>
                                    @elseif($item->d_withdraw_status==0)
                                    <a href="{{route('deposit_withdraw_statas',['id'=>$item->id])}}" class="btn btn-danger" title="Inactive">
...
{{--   
                                    ...
                                    <a href="{{  url('/diposit-withdraw/edit/'.$item->id) }}" class="btn btn-success" title="Edit">
                                        <span class="fa fa-pencil font-14  "></span>
                                    </a>
                                    <a href="{{url('/diposit-withdraw/report',$item->id)}}" class="btn btn-info" title="Report">
                                        <span class="fa fa-file font-14"></span>
                      
                                    </a>
                                    <a href="{{  url('diposit-withdraw/delete/'.$item->id) }}" class="btn btn-danger" title="Delete"onclick="return confirm('Are you sure to delete this?')">
             ...
             console.log(deposit_number_id);
              $.ajax({  
                   ...
                   success:function(data){  
                        $('#account_number_withdraw').val(data.d_acc);  
