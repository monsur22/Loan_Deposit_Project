...
<div class="page-content fade-in-up">
        ...
        <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Edit Deposit Collection</div>
                    ...
                    <div class="ibox-body">
                            <form method="POST" action="{{ url('/diposit-withdraw/update') }}">
                                {{csrf_field()}}
                                <div class="row">
                                        <div class="col-sm-4 form-group">
                                          <label>Date</label>
                                          <input class="form-control d_withdraw_date" type="date" id="d_withdraw_date" name="d_withdraw_date"value="{{$data_edit->d_withdraw_date}}"   >
                                          <input class="form-control cId" type="hidden" id="id" name="id" value="{{$data_edit->id}}">
                                        </div>
                                          <div class="col-sm-4 form-group">
                                              <label>Wtihdraw Number</label>
                                              <input class="form-control d_withdraw_number" type="text" id="d_withdraw_number" name="d_withdraw_number"value="{{$data_edit->d_withdraw_number}}" readonly  >
                                          ...
                                          <div class="col-sm-4 form-group">
                                              ...
                                              <select class="form-control select2_demo_1 deposit_number_withdraw" name="deposit_number_withdraw"   id="deposit_number_withdraw">
                                                      @foreach ($deposit_number as $item)
                                                      <option value="{{$item->id}}"@if($item->d_number == $data_edit->deposit_number_withdraw) selected @endif>{{$item->d_number}}</option>
                                                      @endforeach
                                         ...
                                         <div class="col-sm-4 form-group"style="visibility: hidden; display:none;">
                                              ...
                                              {{-- <select class="form-control select2_demo_1 account_number_withdraw" name="account_number_withdraw"value="{{$data_edit->account_number_withdraw}}"   id="account_number_collection">
                                                      @foreach ($deposit_number as $item)
                                                      <option value="{{$item->d_acc}}"@if($item->d_acc == $data_edit->account_number_withdraw) selected @endif>{{$item->d_acc}}</option>
                                                      @endforeach  
                                                      
                                                  </select> --}}
                                                  <input class="form-control account_number_collection" type="text" id="account_number_collection" name="account_number_collection" value="{{$data_edit->account_number_withdraw}}"readonly>
                                             
                                          </div>
                                             
                                          <div class="col-sm-4 form-group">
                                              <label>Name</label>
                                              <input class="form-control d_withdraw_name" type="text" id="d_withdraw_name" name="d_withdraw_name" value="{{$data_edit->d_withdraw_name}}"  readonly>
                                          </div>
                                          <div class="col-sm-4 form-group">
                                            <label>Collection Type</label>
                                            <select class="form-control d_withdraw_type" name="d_withdraw_type" id="d_withdraw_type">
                                              ...
                                              <option value="Bank">Bank</option>
                                                ...
                                                <input class="form-control d_withdraw_amount" type="number" id="d_withdraw_amount" name="d_withdraw_amount" value="{{$data_edit->d_withdraw_amount}}"  >
                                            </div>
...
<script>
    $(document).ready(function(){  
         $('#deposit_number_withdraw').change(function(){  
             ...
             console.log(deposit_number_id);
              $.ajax({  
                   ...
                   success:function(data){  
                        ...
                        $('#d_withdraw_name').val(data.d_name);  
                        console.log(data);
