...
<h3> <u>Income Statement</u> </h3>
 ...
 <div class="ibox"style="margin-top: 5px;">
            ...
            <div class="ibox-head">
                    ...
                    <form action="{{url('user/income-statement')}}" method="get">
                                {{ csrf_field() }}
                                <div class="row">
            ...
            <div class="ibox-body">
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <td>{{$item->i_amount}}</td>
                            <td>
                                <a href="{{url('user/income-statement-report/'.$item->id)}}" class="btn btn-info" title="Report">
