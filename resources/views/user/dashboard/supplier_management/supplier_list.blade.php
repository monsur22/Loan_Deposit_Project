...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <form method="POST" action="{{ url('/user/supplierlist') }}">
            {{csrf_field()}}
...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <form method="POST" action="{{ url('/user/supplierlist/update') }}">
            {{csrf_field()}}
            <div class="modal-body">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{-- <a href="{{  url('/user/supplier/delete/'.$suplier->id) }}" class="btn btn-danger" title="Delete"onclick="return confirm('Are you sure to delete this?'); ">
